...
### Жүктеу беті (қойманы таңдау)

![Жүктеу беті — ImageKit немесе AWS S3 таңдауы](./images/upload_page.png)

### Таспа (жазбалар мен Storage белгілері)

![Таспа — ImageKit және S3 бойынша жазбалар](./images/feed_page.png)
