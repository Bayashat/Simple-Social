...
# Optional: used when building transformed URLs client-side (`helper.build_url`);
# not required for uploads.
URL_ENDPOINT: str | None = (
    os.environ.get("IMAGEKIT_URL_ENDPOINT") or os.environ.get("IMAGEKIT_URL") or None
)
